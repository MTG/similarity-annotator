...
urlpatterns = [
    ...
    url(r'^(?P<exercise_id>[0-9]+)/(?P<tier_id>[0-9]+)/edit/$', views.tier_edit, name='tier_edit'),
    url(r'^(?P<exercise_id>[0-9]+)/(?P<tier_id>[0-9]+)/delete/$', views.tier_delete, name='tier_delete'),
