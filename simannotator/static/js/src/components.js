...
function PlayBar(wavesurfer, container) {
...
PlayBar.prototype = {
    ...
    update: function() {
        ...
        $(this.container).append(this.playBarDom);
        this.events = [];
        this.updateTimer();
    },
    ...
    addWaveSurferEvents: function() {
        ...
        this.wavesurfer.on('play', function () {
            $(my.container).find('.play_audio').removeClass('fa-play-circle').addClass('fa-stop-circle');
        });
        
        this.wavesurfer.on('pause', function () {
            $(my.container).find('.play_audio').removeClass('fa-stop-circle').addClass('fa-play-circle');
        }); 
...
WorkflowBtns.prototype = {
    ...
    create: function() {
        ...
        this.nextBtn = $('<button>', {
            class: 'btn submit',
            text: 'STORE ANNOTATIONS & LOAD NEXT TIER'
        });
